    ...
    <div class="my-3 p-3 bg-white rounded shadow-sm">
        <div class="row">
            ...
            <div class="col-12 col-md-9">
                <a class="text-primary" href="{{ route('management.sales-completed.sale') }}">
                ...
                <div class="col-md-12 order-md-1">
                    <form class="needs-validation" novalidate="">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-6">
                                <label for="valor_venda">Quantidade:</label>
                                <input type="text" class="form-control" id="valor_venda" name="valor_venda" value="{{ $paginate->quantidade }}">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <a href="{{ route('management.sales-completed.sale') }}" class="btn btn-primary btn-lg btn-block">Voltar</a>
                            </div>
